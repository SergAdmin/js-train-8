...
function getUsersFromDatabase(array) {
  ...
  return Array.from(array, (user) => ({
    //створюємо новий масив users, використовуючи array як джерело даних
    id: user.id,
...
function createArray(...elements) {
  ...
  if (elements.length > 0) {
    const el = Array.of(...elements);
    return el;
  } else {
    console.log(`Вхідний об'єкт не містить елементів.`);
    return [];
  }
}
...
function sortByKey(arr, key) {
  ...
  //arr.sort(a: key,);
  //Array.sort(compareFn?: ((a: T, b: T) => number) | undefined): this
  let a;
  let b;
...
console.log(
  `Помилка в умові, скоріш за все, малась на увазі не довжина масива, а довжина elements`
);
